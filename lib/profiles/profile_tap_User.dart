...
class _ProfileDesignState extends State<ProfileUser> {
  ...
  Future<void> _pickAndUploadImage() async {
    ...
    if (pickedFile != null) {
     ...
     String? newImageUrl = await ApiManagerProfiles.uploadProfileImage(_profileImage!, context);
      if (newImageUrl != null) {
        setState(() {
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      child:( _imageUrl == null)
                       ? const Icon(Icons.person, size: 65, color: Constant.greyColor4)
                       : null, 
                    ),
                    ...
                    Positioned(
                      ...
                      ? const CircularProgressIndicator(color: Colors.white)
                       ...
                       color: Constant.whiteColor, size: 16,),
                    ),
                   ),
                   ),
                 ...
                 Positioned(
                  ...
                  child: GestureDetector(
                    ...
                    child: const CircleAvatar(
                      radius: 13,
                      backgroundColor: Constant.mainColor,
                      child: Icon(FontAwesomeIcons.trash, color: Colors.white, size: 13),
                    ),
                  ),
                ),
                  ],

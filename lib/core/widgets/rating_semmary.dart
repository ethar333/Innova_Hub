...
class RatingSummary extends StatelessWidget {
  const RatingSummary({
    ...
    this.labelCounterFiveStars = const Row(
      spacing: 5,
      children: [
        Text(
          '5',
    ...
    this.labelCounterFourStars = const Row(
      spacing: 5,
      children: [
        Text(
          '4',
    ...
    this.labelCounterThreeStars = const Row(
      spacing: 5,
      children: [
        Text(
          '3',
    ...
    this.labelCounterTwoStars = const Row(
      spacing: 5,
      children: [
        Text(
          '2',
    ...
    this.labelCounterOneStars = const Row(
      spacing: 5,
      children: [
        Text(
          '1',
